...
* [d] Review each [design file](design-files).  Notice the subtle differences between them all. 
* [d] Insert a `viewport` meta tag into the head of the project with these html attributes: `content="width=device-width, initial-scale=1"`
* [d] Introduce max-width media queries into your project at 800px and 500px  
* [d] Do your best to make your styles match the design files at each breakpoint 
